...
export class Match {
        ...
        this.pendingTimeouts.push(setTimeout(() => {
            ...
            this.pendingTimeouts.push(setTimeout(() => {
                ...
                this.pendingTimeouts.push(setTimeout(() => {
                    ...
                    this.ball.serve();
                    if (this.aiLeft)
                        this.aiLeft.oneSecondLoop();
                    if (this.aiRight)
                        this.aiRight.oneSecondLoop();
                    this.last = performance.now();
                    this.ballLoopRafId = requestAnimationFrame(this.ballLoop);
    ...
    endMatch(winner) {
        ...
        saveTournamentMatch(this.matchPlayer[0], this.matchPlayer[1], this.matchPlayer[0].point, this.matchPlayer[1].point, winner);
