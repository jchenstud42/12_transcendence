...
const AIviewsCanvas = document.getElementById('canvas-AI-views');
AIviewsCanvas.width = PONG_WIDTH;
AIviewsCanvas.height = PONG_HEIGHT;
const ctx = AIviewsCanvas.getContext('2d');
