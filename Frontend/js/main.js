...
initProfile({
    ...
    avatarInput: document.getElementById("edit-avatar"),
...
function renderMatchHistory(matches) {
    ...
    matches.forEach(match => {
        ...
        const winner = match.winnerId ? (match.winnerId === ((_a = match.player1) === null || _a === void 0 ? void 0 : _a.id) ? (_b = match.player1) === null || _b === void 0 ? void 0 : _b.username : (_c = match.player2) === null || _c === void 0 ? void 0 : _c.username) : t("draw");
        const player1Name = ((_d = match.player1) === null || _d === void 0 ? void 0 : _d.username) || "`NULL";
        const player2Name = ((_e = match.player2) === null || _e === void 0 ? void 0 : _e.username) || "NULL";
        div.innerHTML = `
...
class Player {
    constructor(name, isAi, playerNbr, userId) {
        this.name = "";
        this.playerNbr = 0;
        this.paddle = null;
        this.point = 0;
