...
export function initUIEvents(elems) {
    ...
    (_e = elems.back_button) === null || _e === void 0 ? void 0 : _e.addEventListener("click", () => { var _a; return (_a = elems.pong_menu) === null || _a === void 0 ? void 0 : _a.classList.add("hidden"); });
    (_f = elems.start_button) === null || _f === void 0 ? void 0 : _f.addEventListener("click", () => 
    // toggleMenu(
    // 	elems.edit_menu,
    // 	elems.twoFA_menu,
    // 	elems.friends_menu,
    ...
    // )
    alert("Bouton du cul"));
    (_g = elems.friends_button) === null || _g === void 0 ? void 0 : _g.addEventListener("click", () => toggleMenu(elems.friends_menu, elems.twoFA_menu, elems.edit_menu, elems.history_menu, elems.twofaTypeMenu, elems.language_menu));
    (_h = elems.history_button) === null || _h === void 0 ? void 0 : _h.addEventListener("click", () => toggleMenu(elems.history_menu, elems.twoFA_menu, elems.friends_menu, elems.edit_menu, elems.twofaTypeMenu, elems.language_menu));
    if (elems.language_button && elems.language_menu) {
        ...
        initLanguage();
        (_j = elems.language_menu.querySelector(".en")) === null || _j === void 0 ? void 0 : _j.addEventListener("click", () => setLanguage("en"));
        (_k = elems.language_menu.querySelector(".fr")) === null || _k === void 0 ? void 0 : _k.addEventListener("click", () => setLanguage("fr"));
        (_l = elems.language_menu.querySelector(".es")) === null || _l === void 0 ? void 0 : _l.addEventListener("click", () => setLanguage("es"));
    }
}
