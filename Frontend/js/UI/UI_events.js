...
export function initUIEvents(elems) {
    ...
    (_a = elems.register_button) === null || _a === void 0 ? void 0 : _a.addEventListener("click", () => {
        resetRegisterForm();
        toggleMenu(elems.registerContainer, elems.loginContainer, elems.language_menu);
    });
    (_b = elems.login_button) === null || _b === void 0 ? void 0 : _b.addEventListener("click", () => {
        resetLoginForm();
        toggleMenu(elems.loginContainer, elems.registerContainer, elems.language_menu);
    });
    (_c = elems.profile_button) === null || _c === void 0 ? void 0 : _c.addEventListener("click", () => {
        toggleMenu(elems.profile_menu, elems.language_menu);
        hideMenu(elems.edit_menu);
    });
    (_d = elems.edit_button) === null || _d === void 0 ? void 0 : _d.addEventListener("click", () => {
        resetProfileForm();
        toggleMenu(elems.edit_menu, elems.twoFA_menu, elems.friends_menu, elems.history_menu, elems.global_stats_menu, elems.twofaTypeMenu, elems.language_menu);
    });
    ...
    (_g = elems.start_button) === null || _g === void 0 ? void 0 : _g.addEventListener("click", () => {
        ...
        openPong(elems);
        toggleMenu(elems.edit_menu, elems.twoFA_menu, elems.friends_menu, elems.history_menu, elems.global_stats_menu, elems.twofaTypeMenu, elems.language_menu, elems.registerContainer, elems.loginContainer, elems.profile_menu);
        resetGameMenu();
    });
    (_h = elems.friends_button) === null || _h === void 0 ? void 0 : _h.addEventListener("click", () => toggleMenu(elems.friends_menu, elems.twoFA_menu, elems.edit_menu, elems.history_menu, elems.global_stats_menu, elems.twofaTypeMenu, elems.language_menu));
    (_j = elems.history_button) === null || _j === void 0 ? void 0 : _j.addEventListener("click", () => toggleMenu(elems.history_menu, elems.global_stats_menu, elems.twoFA_menu, elems.friends_menu, elems.edit_menu, elems.twofaTypeMenu, elems.language_menu));
...
function resetProfileForm() {
    ...
    const confirmPasswordInput = document.getElementById("edit-password-confirm");
    if (usernameInput)
        usernameInput.value = "";
    if (emailInput)
        emailInput.value = "";
...
function resetLoginForm() {
    const loginUsernameInput = document.getElementById("login-id");
...
function resetRegisterForm() {
    ...
    const registerConfirmPasswordInput = document.getElementById("confirm-password");
...
export function resetTwoFAForm() {
    const twoFAInput = document.getElementById("enter_2fa");
    if (twoFAInput)
        twoFAInput.value = "";
}
