...
function openDestinationModal(type) {
    ...
    pongScreen === null || pongScreen === void 0 ? void 0 : pongScreen.classList.add("hidden");
    if (type === "email") {
    ...
    validateButton === null || validateButton === void 0 ? void 0 : validateButton.addEventListener("click", () => {
        elems.destinationModal.classList.add("hidden");
        const pongScreen = document.getElementById("ecran-pong");
        pongScreen === null || pongScreen === void 0 ? void 0 : pongScreen.classList.remove("hidden");
        const startButton = document.getElementById("pong-start-button");
        startButton === null || startButton === void 0 ? void 0 : startButton.classList.remove("hidden");
    });
...
async function handleEnableDestination() {
    ...
    try {
        ...
        if (!res.ok) {
            alert(t("error_prefix") + getServerErrorMessage(data === null || data === void 0 ? void 0 : data.error));
            return;
        }
...
export function init2FA(elements, callbacks, initial2FAState) {
    ...
    funcs = callbacks;
    ensureInit();
    const { profile_menu, start_button, verify_qr, destinationCancel, destinationConfirm, btnEmail, btnSMS, btnQR, twofaToggleBtn, twoFA_profile_button, oauth42Btn, twofaTypeMenu, twofaForm } = elems;
    ...
    if (twofaToggleBtn)
        twofaToggleBtn.addEventListener("click", async () => {
            ...
            if (!is2FAEnabled) {
                ...
                if ((_a = document.getElementById("ecran-pong")) === null || _a === void 0 ? void 0 : _a.classList.contains("hidden"))
                    (_b = document.getElementById("ecran-pong")) === null || _b === void 0 ? void 0 : _b.classList.remove("hidden");
    ...
    if (twoFA_profile_button) {
        twoFA_profile_button.addEventListener("click", async () => {
            ...
            if (isHidden) {
                toggleMenu(elems.twoFA_menu, document.getElementById("edit-profile-menu"), document.getElementById("friends-menu"), document.getElementById("history-menu"), document.getElementById("language-menu"));
