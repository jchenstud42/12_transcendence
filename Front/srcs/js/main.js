...
function updatePageLanguage() {
    ...
    const regLabels = register_form === null || register_form === void 0 ? void 0 : register_form.querySelectorAll("label");
    if (regLabels) {
    ...
    const regBtn = register_form === null || register_form === void 0 ? void 0 : register_form.querySelector('button[type="submit"]');
    if (regBtn)
        regBtn.textContent = translate("register");
    const logLabels = login_form === null || login_form === void 0 ? void 0 : login_form.querySelectorAll("label");
    if (logLabels) {
        logLabels[0].textContent = translate("loginId");
        logLabels[1].textContent = translate("password");
    }
    const logBtn = login_form === null || login_form === void 0 ? void 0 : login_form.querySelector('button[type="submit"]');
    if (logBtn)
        ...
        if (submit) {
            ...
            try {
                ...
                if (res.ok) {
                    ...
                    applyLoggedInState((data === null || data === void 0 ? void 0 : data.user) || { id: 0, username: '', email: '' });
                    register_form.reset();
