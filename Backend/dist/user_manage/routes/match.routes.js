...
export default async function matchRoutes(fastify) {
    ...
    fastify.post("/", { preHandler: [authentizer()] }, async (req, reply) => {
        const { player1Id, player2Id, score1, score2, winnerId, player1Name, player2Name, nbrOfBallHit, nbrOfBallMissed, matchTime } = req.body;
        ...
        const match = await matchService.addMatch(dbPlayer1Id, dbPlayer2Id, score1, score2, dbWinnerId, player1Name, player2Name, nbrOfBallHit, nbrOfBallMissed, matchTime);
