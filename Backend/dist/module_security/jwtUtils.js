...
/*
 ...
 - Les Json Web token c'est quoi ?
  ...
  bisous
*/
const JWT_SECRET = (process.env.JWT_SECRET ?? "default_secret_change_me_hihi");
...
export function signAccessToken(userId, twoFA = false) {
    return jwt.sign({ sub: userId, twoFA }, JWT_SECRET, { algorithm: "HS256", expiresIn: ACCESS_EXPIRES_SEC });
}
